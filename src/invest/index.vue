<template>
  <el-row>
    ...
    <el-col style="width: 100%; color: rgb(0, 43, 255); background-color: rgb(251, 252, 255); opacity: 0.7; height: 60px;" :span="12">
      <el-link style="width: 10%; height: 20px; left: 300px; bottom: -5px; top: 20px; font-weight: bold;" @click="goPath('BorrowMoney')">首页</el-link>
      ...
      <el-link style="width: 10%; margin-left: 0px; left: 300px; top: 20px; font-weight: bold; height: 20px;" @click="goPath('myaccount')">我的账户</el-link>
